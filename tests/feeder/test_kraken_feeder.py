...
from tradingkit.data.feed.kraken_feeder import KrakenFeeder
...
class TestKrakenFeeder(TestCase):
    ...
    def test_trade_data_format(self):
        ...
        trade = KrakenFeeder.transform_trade_data(KrakenFeeder, kraken_real_trade_info)[0]
    ...
    def test_book_data_format(self):
        ...
        book = KrakenFeeder.transform_book_data(KrakenFeeder, kraken_real_book_info)
    ...
    def test_order_data_format(self):
        ...
        order = KrakenFeeder.transform_order_data(KrakenFeeder, kraken_real_order_info)[0]
