 ...
 */
 (function ( global, factory ) {
	...
	if ( typeof define !== 'undefined' && define.amd ) {
		define('canvgModule', [ 'src/display/Highstock/code/lib/rgbcolor', 'stackblur' ], factory );
	}

	// ...or as browserify
	else if ( typeof module !== 'undefined' && module.exports ) {
		module.exports = factory( require( 'src/display/Highstock/code/lib/rgbcolor' ), require( 'stackblur' ) );
	}
